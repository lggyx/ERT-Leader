            ...
            <a-col :span="8">
              <a-card title="E 维度">
                <div style="font-size: 24px; font-weight: bold; color: #1890ff">
                  {{ result.dimensionScores?.e?.score || '—' }}
                </div>
                <div style="color: #666; margin-top: 8px">
                  级别：{{ result.dimensionScores?.e?.level || '—' }}
                </div>
                <div style="color: #999; font-size: 12px; margin-top: 4px">
                  {{ result.dimensionScores?.e?.description || '' }}
                </div>
              </a-card>
            </a-col>
            <a-col :span="8">
              <a-card title="R 维度">
                <div style="font-size: 24px; font-weight: bold; color: #52c41a">
                  {{ result.dimensionScores?.r?.score || '—' }}
                </div>
                <div style="color: #666; margin-top: 8px">
                  级别：{{ result.dimensionScores?.r?.level || '—' }}
                </div>
                <div style="color: #999; font-size: 12px; margin-top: 4px">
                  {{ result.dimensionScores?.r?.description || '' }}
                </div>
              </a-card>
            </a-col>
            <a-col :span="8">
              <a-card title="T 维度">
                <div style="font-size: 24px; font-weight: bold; color: #fa541c">
                  {{ result.dimensionScores?.t?.score || '—' }}
                </div>
                <div style="color: #666; margin-top: 8px">
                  级别：{{ result.dimensionScores?.t?.level || '—' }}
                </div>
                <div style="color: #999; font-size: 12px; margin-top: 4px">
                  {{ result.dimensionScores?.t?.description || '' }}
                </div>
              </a-card>
            </a-col>
          </a-row>
